  ...
  return (
    <section id="contact" className="relative py-20 md:py-28 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/4 right-1/4 w-4 h-4 rounded-full bg-white/20 animate-[float-1_4s_ease-in-out_infinite]" />
        <div className="absolute bottom-1/3 left-1/3 w-3 h-3 rounded-full bg-white/15 animate-[float-2_5s_ease-in-out_infinite]" />
        <div className="absolute top-1/2 right-1/6 w-2 h-2 rounded-full bg-white/25 animate-[float-3_6s_ease-in-out_infinite]" />
      </div>
      ...
      <div className="container relative z-10">
        ...
        >
          ...
          <p className="font-body text-base md:text-lg text-white/80 mb-8">
